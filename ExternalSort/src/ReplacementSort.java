...
public class ReplacementSort {
    ...
    public static LinkedList<Run> replacementSort(
        ...
        String testFileName = "runFile.txt";
        PrintWriter p = new PrintWriter(testFileName);
        ...
        while (finishHeap) {
            ...
            while (heap.heapsize() > 0) {
                ...
                if (!outputBuffer.hasRemaining()) {
                    ...
                    outputBuffer.rewind();
                    for (int x = 0; x < outputIndex; x++) {
                        p.write(outputBuffer.getLong() + " " + outputBuffer
                            .getDouble() + "\n");
                    }
                    outputIndex = 0;
            ...
            outputBuffer.rewind();
            for (int x = 0; x < outputIndex; x++) {
                p.write(outputBuffer.getLong() + " " + outputBuffer.getDouble()
                    + "\n");
